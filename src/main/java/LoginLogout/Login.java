    ...
    private void loginbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginbuttonActionPerformed
    	...
    	FileWriter writer;
 		...
 		try {
 			...
 			String cool = ("SELECT EintraegeNr FROM eintraege WHERE Mitarbeiter_ID = '"+Login.username+"'");
 			String cool1 = ("SELECT Mitarbeiter_ID FROM eintraege WHERE Mitarbeiter_ID = '"+Login.username+"'");
 			String cool2 = ("SELECT Datum FROM eintraege WHERE Mitarbeiter_ID = '"+Login.username+"'");
 			String cool3 = ("SELECT Beginn FROM eintraege WHERE Mitarbeiter_ID = '"+Login.username+"'");
 			String cool4 = ("SELECT Pause FROM eintraege WHERE Mitarbeiter_ID = '"+Login.username+"'");
 			String cool5 = ("SELECT Ende FROM eintraege WHERE Mitarbeiter_ID = '"+Login.username+"'");
 			String cool6 = ("SELECT Art FROM eintraege WHERE Mitarbeiter_ID = '"+Login.username+"'");
 			String cool7 = ("SELECT KW FROM eintraege WHERE Mitarbeiter_ID = '"+Login.username+"'");
 			String cool8 = ("SELECT Quartal FROM eintraege WHERE Mitarbeiter_ID = '"+Login.username+"'");
 			String cool9 = ("SELECT Jahr FROM eintraege WHERE Mitarbeiter_ID = '"+Login.username+"'");
 			String cool10 = ("SELECT Saldo FROM eintraege WHERE Mitarbeiter_ID = '"+Login.username+"'");
 			java.sql.PreparedStatement pst = con1.prepareStatement(cool);
 			java.sql.PreparedStatement pst1 = con1.prepareStatement(cool1);
 			java.sql.PreparedStatement pst2 = con1.prepareStatement(cool2);
 			java.sql.PreparedStatement pst3 = con1.prepareStatement(cool3);
 			java.sql.PreparedStatement pst4 = con1.prepareStatement(cool4);
 			java.sql.PreparedStatement pst5 = con1.prepareStatement(cool5);
 			java.sql.PreparedStatement pst6 = con1.prepareStatement(cool6);
 			java.sql.PreparedStatement pst7 = con1.prepareStatement(cool7);
 			java.sql.PreparedStatement pst8 = con1.prepareStatement(cool8);
 			java.sql.PreparedStatement pst9 = con1.prepareStatement(cool9);
 			java.sql.PreparedStatement pst10 = con1.prepareStatement(cool10);
 			ResultSet rs = pst.executeQuery();
 			ResultSet rs1 = pst1.executeQuery();
 			...
 			rs9.next();
 			rs10.next();
 			int Eintrage = rs.getInt(1);
 			String Mitarbeiter_ID = rs1.getString(1);
 			String Datum = rs2.getString(1);
 			String Beginn = rs3.getString(1);
 			String Pause = rs4.getString(1);
 			String Ende = rs5.getString(1);
 			String Art = rs6.getString(1);
 			String KW = rs7.getString(1);
 			String Quartal = rs8.getString(1);
 			String Jahr = rs9.getString(1);
 			String Saldo = rs10.getString(1);
 			writer = new FileWriter(Datei, true);
 			writer.write(Eintrage+"\t");
 			writer.write(Mitarbeiter_ID+"\t");
 			writer.write(Datum+"\t");
 			writer.write(Beginn+"\t");
 			writer.write(Pause+"\t");
 			writer.write(Ende+"\t");
