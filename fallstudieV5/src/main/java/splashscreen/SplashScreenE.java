...
public class SplashScreenE extends javax.swing.JDialog {

    public SplashScreenE(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        curvesPanel1Layout.setVerticalGroup(
            ...
            .addGroup(curvesPanel1Layout.createSequentialGroup()
                .addGap(186, 186, 186)
                .addComponent(pro, javax.swing.GroupLayout.PREFERRED_SIZE, 13, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SplashScreenE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SplashScreenE dialog = new SplashScreenE(new javax.swing.JFrame(), true);
