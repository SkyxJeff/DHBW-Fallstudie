...
public class LogoutEng extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fragelabel.setText("Are you sure you want to logout?");

        ja_button.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        ja_button.setText("Yes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LogoutEng.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
