...
import PasswortAendern.PasswortEng;
...
public class Einstellungen_SeiteEng extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        passwortAendern_label.setText("Change password:");

        passwortAendern_button.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        passwortAendern_button.setText("Change password:");
        ...
        grenzwerte_label.setText("Traffic-light settings");
        ...
        try {
        	...
        	rs2.next();
        	 ...
        	 rot = rs2.getInt(1);
					...
					JOptionPane.showMessageDialog(null, "Could not connect to database. Traffic-light boundaries were not changed.");
        ...
        loeschen_button.setText("Delete");
    ...
    private void passwortAendern_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_passwortändern_buttonActionPerformed
        new PasswortEng().setVisible(true);
    ...
    private void speichern_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_speichern_buttonActionPerformed
        try {
            ...
            String Update = ("UPDATE gleitzeitgrenze SET Gruen= '"+gruen+"', Gelb= '"+gelb+"', Rot= '"+rot+"' WHERE MitarbeiterID = '"+LoginEng.username+"'");
            java.sql.PreparedStatement pst = con.prepareStatement(Update);
            pst.executeUpdate();
            JOptionPane.showMessageDialog(null, "The boundaries were changed.");
