...
public class Einstellungen_SeiteE extends javax.swing.JPanel {
    ...
    private void speichern_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_speichern_buttonActionPerformed
        try {
            ...
            String Update = ("UPDATE gleitzeitgrenze SET Gruen= '"+gruen+"', Gelb= '"+gelb+"', Rot= '"+rot+"' WHERE MitarbeiterID = '"+LoginE.username+"'");
            ...
            JOptionPane.showMessageDialog(null, "That didn't work, there was an error.");
        }
