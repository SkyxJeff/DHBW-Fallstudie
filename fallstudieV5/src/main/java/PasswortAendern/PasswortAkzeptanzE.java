...
public class PasswortAkzeptanzE extends javax.swing.JFrame {

    public PasswortAkzeptanzE() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PasswortAkzeptanzE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PasswortAkzeptanzE().setVisible(true);
            }
        });
    }
