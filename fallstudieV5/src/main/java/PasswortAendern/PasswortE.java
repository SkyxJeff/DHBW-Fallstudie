...
public class PasswortE extends javax.swing.JFrame {
    ...
    private void speichern_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_speichern_buttonActionPerformed
        ...
        System.out.println(LoginE.username);
        String sql1 = "Select Passwort from login_daten_mitarbeiter where Mitarbeiter_ID='"+LoginE.username+"';";
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (altesPW.equals(altPWDB) && !altesPW.equals("start")) {
                    ...
                    boolean pwPruef = LoginE.passwortPruefen(neuesPW);
                    if(pwPruef) {
                        String sql2 = "Update login_daten_mitarbeiter set Passwort = '"+neuesPasswort_textfeld.getText()+"'where Mitarbeiter_ID= '"+LoginE.username+"';";
                ...
                } else {JOptionPane.showMessageDialog(null, "Couldn't apply changes, please try again.");}
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PasswortE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
