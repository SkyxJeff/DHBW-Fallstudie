...
public class PasswortAkzeptanzEng extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        gespeichert_label.setText("New password saved!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PasswortAkzeptanzEng.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PasswortAkzeptanzEng().setVisible(true);
            }
        });
    }
