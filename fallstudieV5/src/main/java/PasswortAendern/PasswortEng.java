...
public class PasswortEng extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Ueberschrift_label.setText("Change password");
        ...
        altesPasswort_label.setText("Old password:");
        ...
        neuesPasswort_label.setText("New password:");
        ...
        abbrechen_button.setText("Cancel");
    ...
    private void speichern_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_speichern_buttonActionPerformed
        ...
        System.out.println(LoginEng.username);
        String sql1 = "Select Passwort from login_daten_mitarbeiter where Mitarbeiter_ID='"+LoginEng.username+"';";
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (altesPW.equals(altPWDB) && !altesPW.equals("start")) {
                    ...
                    boolean pwPruef = LoginEng.passwortPruefen(neuesPW);
                    if(pwPruef) {
                        String sql2 = "Update login_daten_mitarbeiter set Passwort = '"+neuesPasswort_textfeld.getText()+"'where Mitarbeiter_ID= '"+LoginEng.username+"';";
                ...
                } else {JOptionPane.showMessageDialog(null, "Changes could not be applied.");}
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PasswortEng.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
